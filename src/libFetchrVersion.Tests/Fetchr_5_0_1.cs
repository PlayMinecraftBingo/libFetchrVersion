...
{
    [TestClass]
    public class Fetchr_5_0_1
    {
        private readonly FetchrVersion fetchr = FetchrVersion.Fetchr_5_0_1;
        ...
        {
            Assert.IsTrue(fetchr.IsValidMinecraftVersion(MinecraftVersion.Minecraft_1_16_5));
        }

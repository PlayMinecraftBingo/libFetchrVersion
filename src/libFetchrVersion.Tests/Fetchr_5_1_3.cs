...
{
    [TestClass]
    public class Fetchr_5_1_3
    {
        private readonly FetchrVersion fetchr = FetchrVersion.Fetchr_5_1_3;
        ...
        {
            Assert.IsTrue(fetchr.IsValidMinecraftVersion(FetchrMinecraftVersion.Minecraft_1_20_2));
        }

        [TestMethod]
        public void Minecraft_1_20_6()
        {
            Assert.IsTrue(fetchr.IsValidMinecraftVersion(FetchrMinecraftVersion.Minecraft_1_20_6));
        }
